export const APP_DEFS = [
  { id: "files", name: "Projects", icon: "files", color: "#2563eb", desc: "Portfolio projects" },
  ...
  { id: "games", name: "Games", icon: "games", color: "#C9A84C", desc: "Playable games • Bridge Horror House" },
...
export const DOCK_ORDER = ["files","browser","terminal","music","gallery","games","notes","contact","settings"];
